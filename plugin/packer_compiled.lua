...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-calc", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-nvim-lua" },
    loaded = true,
    only_config = true
  },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "playground", "neorg" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter', 'plenary.nvim', 'indent-blankline.nvim', 'nvim-lspinstall'}, { event = "BufRead *" }, _G.packer_plugins)]]
