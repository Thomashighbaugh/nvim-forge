...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'plenary.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'nvim-lspinstall', 'nvim-colorizer.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
