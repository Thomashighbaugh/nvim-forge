local err = require('forge.core.lib.err')
local M = {}

-- Required tools
local required_externals = {  'python3', 'rg', 'git', 'curl' }
...
function M.setup(opts)
  local colorscheme = require('forge.core.colorscheme')
  local command = require('forge.core.command')
  local config = require('forge.core.config')
  local plugin = require('forge.core.plugin')
  local reload = require('forge.core.reload')
