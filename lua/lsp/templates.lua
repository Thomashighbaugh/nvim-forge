...
local nvoid_lsp_utils = require("lsp.utils")

local ftplugin_dir = lsp.templates_dir
...
local skipped_filetypes = lsp.automatic_configuration.skipped_filetypes
local skipped_servers = lsp.automatic_configuration.skipped_servers
local ensure_installed_servers = lsp.installer.setup.ensure_installed
