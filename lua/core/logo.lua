...
--- @param type "saturn" | "saturn_plus" | "earth" | "rowan_cap" | "graffiti" | "ogre" | "slant_relief" | "ansi_shadow" | "delta_corps_priest1" | "colossal" | "def_leppard" | "sharp"
M.logos.generate = function(type)
  return vim.split("\n" .. logos[type], "\n")
end

M.logos.random = function()
  ...
  return vim.split(logos[random_logo_name], "\n")
end
