...
map("n", "<M-CR>", "vim.lsp.buf.code_action()<CR>")
...
wk.register({
  ...
  f = {
    ...
    f = {
      "<cmd>" .. require("utils.functions").project_files() .. "<cr>",
      "Find File",
    },
  ...
  L = {
    ...
    L = { "<cmd>Lazy load<cr>", "Lazy Load" },
    h = { "<cmd>Lazy help<cr>", "Lazy Help" },
    H = { "<cmd>Lazy home<cr>", "Lazy Home" },
    C = { "<cmd>Lazy clear<cr>", "Lazy Clear" },
    ...
    r = { "<cmd>Lazy reload<cr>", "Lazy Reload" },
  ...
  q = {
    ...
    q = {
      "<cmd>lua require('utils.functions').toggle_qf()<cr>",
  ...
  p = {
    "<cmd>ProjectTODOs<cr>",
    "Toggle Project or Global TODOs",
  },
  --  +-------------------------------------------------------------------------+
