...
---@field inlay_hints features.lsp.inlay_hints
---@field codelens features.lsp.codelens
---@field document_highlight features.lsp.document_highlight
---@field ui features.lsp.ui
local M = {}
