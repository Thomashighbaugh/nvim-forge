---@class TelescopeOpts: utils.pick.Opts
---@field follow? boolean

---@class TelescopeThemeOpts: utils.pick.ThemeOpts
...
return {
		...
		opts = function()
			...
			local opts = {
				defaults = {
					...
					selection_caret = "  ",
					entry_prefix = "   ",
					borderchars = is_telescope_bg_clear and Utils.ui.borderchars("rounded") or {
...

	{
		...
		opts = function()
			...
			local Keys = require("features.lsp.keymaps").get()
      -- stylua: ignore
