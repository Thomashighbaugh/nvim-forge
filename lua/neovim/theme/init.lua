local _, colors = pcall(require, 'neovim.theme.colors')
if not colors then
    return
end
local highlight = require('neovim.theme.utils').highlight
local get_highlight = require('neovim.theme.utils').get_highlight
local set_highlight = require('neovim.theme.utils').set_highlight
