...
return {
	{
		...
		keys = {
			{ "<leader>Rs", "<cmd>lua require('muren.api').toggle_ui()<CR>", desc = "Search and Replace" },
			{ "<leader>RS", "<cmd>lua require('muren.api').open_fresh_ui()<CR>", desc = "Search and Replace Fresh" },
			{
				"<leader>RU",
		...
		config = function()
			...
			require("statuscol").setup({
				...
				segments = {
					...
					{ text = { "%s" }, click = "v:ScSa" }, -- Sign
					{ text = { builtin.foldfunc, " " }, click = "v:ScFa" }, -- Fold
				},
			})
