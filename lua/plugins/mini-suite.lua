...
return {
    {
        ...
        config = function()
            ...
            -- │                   MINI.COMPLETION                       │
            -- ╰─────────────────────────────────────────────────────────╯
            -- Completion replacement for nvim-cmp with cmdline support
            require('mini.completion').setup({
                -- Delay (debounce type, in ms) between certain Neovim event and action.
                -- This can be used to (virtually) disable certain automatic show triggers.
                ...
                lsp_completion = {
                    ...
                    -- Its output should be a table of the same nature as input. The most
                ...
                -- string. Example: to use 'whole line' completion, supply '<C-x><C-l>'.
